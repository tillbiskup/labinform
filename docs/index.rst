...
Together with ASpecD (*Analysis of Spectral Data*, `Homepage <https://www.aspecd.de/>`_), a framework for handling spectroscopic data focussing on reproducibility, it forms the basis of fully reproducible research without additional costs.
